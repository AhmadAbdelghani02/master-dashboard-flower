            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between mb-6">
                        <h3 class="text-lg font-semibold">Gift Box #{{ $giftBox->box_id }}</h3>
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.gift-boxes.edit', $giftBox) }}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                                Edit
                            </a>
                        ...
                        <div class="border-t border-gray-200">
                            <dl>
                                ...
                                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        @if ($giftBox->order)
                                            Order #{{ $giftBox->order->order_id }}
                                            <a href="#" class="text-blue-600 hover:text-blue-900 ml-2">(View Order)</a>
                                        @else
                                            No associated order
                                        @endif
                                    </dd>
                                ...
                                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        {{ $giftBox->custom_message ?? 'No custom message' }}
                                    </dd>
                                </div>
                                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt class="text-sm font-medium text-gray-500">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        {{ $giftBox->created_at->format('F j, Y, g:i a') }}
                                    </dd>
                                </div>
                            </dl>
                        </div>
